...
parser.add_argument('--dataset', default='nba', choices=['pokec_z','pokec_n','dblp', 'bail', 'credit', 'german', 'income', 'nba'])
...
parser.add_argument('--node', type=int, default=8, help='budget of injected nodes')
parser.add_argument('--edge', type=int, default=32, help='budget of degrees')
...
parser.add_argument('--before', action='store_true', default=True)
